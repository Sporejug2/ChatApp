...
public class Odgovor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.odgovor);

        rvMessage  = (RecyclerView) findViewById(R.id.recyclerView1);
        rvMessage.setHasFixedSize(true);
        rvMessage.setLayoutManager(new LinearLayoutManager(this));

        DownloadTask task = new DownloadTask();
        task.execute("http://10.0.2.2/test/web2/json_get_data2.php");
...
//"http://api.openweathermap.org/data/2.5/weather?q=Osijek,hr&appid=c9ccd774a1f4cbe3ac7ccc7f5c684065"
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {// na backgrount thread
        ...
        protected void onPostExecute(String result) {
            ...
            adapter = new MyAdapter(listItems, Odgovor.this);
            rvMessage.setAdapter(adapter);

        }
    } //
    public void clicked (View v){
        startActivity(new Intent(this,DnevniRaspored.class));
    }
}
